...
import com.example.footballfashion.databinding.ItemOrderBinding;
import com.example.footballfashion.model.Order;
import com.example.footballfashion.util.DateTimeUtils;
...
public class OrderAdapter extends RecyclerView.Adapter<OrderAdapter.OrderViewHolder> {
    ...
    public void onBindViewHolder(@NonNull OrderViewHolder holder, int position) {
        ...
        holder.mItemOrderBinding.tvMenu.setText(order.getClothes());
