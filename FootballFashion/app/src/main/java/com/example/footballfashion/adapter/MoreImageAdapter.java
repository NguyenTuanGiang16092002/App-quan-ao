...
import com.example.footballfashion.databinding.ItemMoreImageBinding;
import com.example.footballfashion.model.Image;
...
public class MoreImageAdapter extends RecyclerView.Adapter<MoreImageAdapter.MoreImageViewHolder> {
    ...
    public void onBindViewHolder(@NonNull MoreImageViewHolder holder, int position) {
        ...
        GlideUtils.loadUrl(image.getUrl(), holder.mItemMoreImageBinding.imageCloth);
    }
